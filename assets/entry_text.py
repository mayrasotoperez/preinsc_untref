...
welcome_tags = '''# **PENDIENTE:** la persona generó un usuario, pero no activó el mismo o no seleccionó propuesta.
                  # **ACTIVO:** ha activado el usuario, pero nunca han impreso el formulario, los datos pueden o no estar completos.
                  # **POTENCIAL:** se ha completado el 100% de los datos requeridos y ha impreso la ultima versión del formulario.
                  # **INSCRIPTO:** dicha preinscripción ya fue procesada y puede encontrarse al alumno en SIU Gestión.'''
